export const API_URL = 'http://connectivitysoftwaresolutions.com/'; // Config[KEY].API_URL;
export const AUTH_URL = 'http://connectivitysoftwaresolutions.com/'; // Config[KEY].AUTH_URL;
export const API_CONSUMER = 'http://connectivitysoftwaresolutions.com/'; // Config[KEY].API_URL;
